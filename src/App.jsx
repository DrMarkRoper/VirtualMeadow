...
export default function App() {
  ...
  useEffect(() => {
    const seed = 12345;
    const { scene, getTerrainHeight, serialise, deserialise, dispose, lights } = buildScene(seed);
    ...
    simRef.current = { scene, bee, beeEye, getTerrainHeight, serialise, deserialise, dispose, seed, lights };
